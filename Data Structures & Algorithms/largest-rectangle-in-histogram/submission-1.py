class Solution:
    def largestRectangleArea(self, heights: List[int]) -> int:
        ...
        # because there is nothing else to subract it/them by (i think this is the reason) actually no, this is the reason:
        # HANDLING LEFTOVERS: WHY WE USE (len(heights) - i)
        # =====================================================================
        # When the main loop finishes, any bars left inside the stack are in a
        # perfectly ascending (increasing) order. 
        #
        # Because they are still in the stack, it means NO bar after them was 
        # ever short enough to kick them out! This implies these leftover bars 
        # were able to successfully stretch all the way to the VERY END of the 
        # histogram.
        #
        # Calculating the Width:
        #   - Where do they end? At the absolute end of the array: len(heights)
        #   - Where did they start? At their stored index: i
        #   - Total Width = (End Position - Start Position) -> len(heights) - i
        for i, h in stack:
