...
# We scan every cell once, and during BFS each cell is processed
# at most once and checks 4 directions.

# Space: O(N)
# The visited set can contain every cell in the worst case,
# and the BFS queue can also contain up to O(N) cells.